...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ai.turintech.catalog.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ai.turintech.catalog.security.DomainUserDetailsService", "createSpringSecurityUser");
